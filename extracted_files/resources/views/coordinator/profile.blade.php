@extends('layouts.app')
@section('page_title','Profile Koordinator')
@section('styles')
<style>
    ...
    .profile-title { font-size:2rem; font-weight:bold; color:#0C447C; margin:0; }
...
<div class="profile-card">
    ...
    <div class="profile-header">
        <div class="profile-title">Profile Koordinator</div>
    ...
    <form method="POST" action="{{ route('coordinator.profile.update') }}" id="profileForm" enctype="multipart/form-data">
        @csrf
        <div class="profile-body">
            <div class="profile-left">
                <table class="profile-data-table">
                    ...
                    <tr>
                        <td class="pl">NIP</td><td class="pc">:</td>
                        <td>
                            <span class="pv" data-field="nip">{{ $user->nip ?? '-' }}</span>
                            <input class="edit-input" type="text" name="nip" value="{{ $user->nip ?? '' }}">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="pv" style="font-weight:600;color:#0C447C;">{{ $user->role === 'coordinator' ? 'Koordinator' : ucfirst($user->role ?? '') }}</td>
                    </tr>
                </table>
